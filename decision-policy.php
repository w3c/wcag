...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US" lang="en-US">
	...
	<body>
		...
		<p>This document explains the decision process of the <a href="./">AG Working Group</a>. It was <a href="http://www.w3.org/2015/09/15-wai-wcag-minutes#item02">accepted by the Working Group 15 September 2015</a>. It was updated editorially 27 January 2017 to change the name of the WG to "Accessibility Guidelines Working Group" and to add links to referenced resources. A substantive update was <a href="https://lists.w3.org/Archives/Public/w3c-wai-gl/2018OctDec/0095.html">approved 20 November 2018</a>.</p>
		<p>The Working Group follows the <a href="http://www.w3.org/Consortium/Process/#Consensus">W3C Process Document</a> regarding decisions. This document provides additional detail about the consensus decision-making process. </p>
		...
		<p>During discussion on a topic, participants are welcome to raise objections freely to help ensure that all available information can be considered and contribute to the best possible decision. However, when the chairs issue a Call for Consensus (CfC), objections should not be raised unless the individual has participated in discussion leading to the CfC, strongly believes the decision is the wrong one in spite of discussion, and the individual cannot "live with" the decision. Compromise on points that the individual considers suboptimal but can "live with" is an essential part of group decisions that must meet various requirements. </p>
		<ol>
			<li> Discussion on a topic proceeds until the chairs believe that all points of view have been expressed and the group has considered the variety of information presented. Depending on the topic, this discussion may take a couple of days or a couple of weeks, or more. 
				<ol>
					<li> Discussion can take place in any <a href="./communication">recognized channel of the Working Group</a> including email on the public AG mailing list, comment threads for GitHub issues or pull requests, or on Working Group calls. </li>
				</ol>
			</li>
			...
			<li>Responding to the Call for Consensus<ol>
					...
					<li>Objections can be raised by replying to the CfC email with “-1” along with a rationale that states:<ol>
			...
			<li>In the rare situation where a <a href="https://www.w3.org/2018/Process-20180201/#FormalObjection">formal objection</a> is raised all the Chairs and staff contact(s) will come to an agreement about the issue and may record a decision with objections per <a href="http://www.w3.org/Consortium/Process/#WGArchiveMinorityViews">section 3.3.2 of the Process Document (Recording and Reporting Formal Objections)</a> and work to address the issue as described in <a href="http://www.w3.org/Consortium/Process/#formal-address">section 3.3.3 of the Process Document (Formally Addressing an Issue)</a>.</li>

		</ol>
		<p>Other aspects of the Working Group decision policy are defined in the Process Document, including <a href="http://www.w3.org/Consortium/Process/#Votes">Votes (section 3.4)</a> and <a href="http://www.w3.org/Consortium/Process/#WGAppeals">Appeal of a Chair’s Decision (section 3.5)</a>. If a participant believes the Chairs have not exercised sound judgment in following this policy, they should express their concern first to one of the Working Group Chairs, escalating if needed to the AG staff contact, and escalating if needed to the W3C Web Accessibility Initiative Lead. </p>

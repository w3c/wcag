...
<head>
	...
	<title>WCAG2ICT Task Force</title>
</head>
...
<body>
	...
	<section id="communication">
		...
		<ul>
			...
			<ul>
				...
				<li>Server: irc.w3.org; Port 6665, 6667, 21, or 994; Channel: #wcag2ict</li>
			</ul>	
			<li><a href="/2002/09/wbs/55145/">Web-Based Surveys (WBS)</a>;</li>
			<li><a href="#teleconferences">Teleconferences of the task force</a> (also see <a href="minutes">meeting minutes</a>);</li>
			<li>Face to face meetings;</li>
		</ul>
		<p>These tools are used by participants of the Task Force. For ways you can contribute, see <a href="#contribute">How to Comment, Contribute, and Participate</a>.</p>
		...
		<section id="email">
			<h3>Mailing Lists</h3>
			<p>The WCAG2ICT TF uses the public-wcag2ict-tf@w3.org mailing list (<a href="http://lists.w3.org/Archives/Public/public-wcag2ict-tf/">mailing list archives</a>) for email discussion. Participants are automatically added to this mailing list when they become a participant of the Task Force. Members of the public can post to this list to send input to the task force.</p>
		</section>
	</section>
	...
	<section id="publications">
		<h2>Publications</h2>
		<p>W3C Working Group Note <a href="https://www.w3.org/TR/wcag2ict/">Applying WCAG 2.x to Non-Web Information and Communications Technologies (WCAG2ICT)</a></p>
	</section>
	...
	<section id="administrative">
		...
		<p>The WCAG2ICT TF is a Task Force of the <a href="http://www.w3.org/WAI/GL/">Accessible Guidelines Working Group (AG WG)</a>.</p>

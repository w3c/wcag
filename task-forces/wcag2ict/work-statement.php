...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" dir="ltr">
	...
	<body>
		...
		<ul>
			<li>Determining how to apply each of the new WCAG 2.1 and WCAG 2.2 (hereafter called “WCAG 2.x”) guidelines and A, AA, and AAA success criteria to non-Web ICT; (this includes provision of additional details for application to closed product software; and</li>
			<li>Producing an updated Working Group Note (a form of W3C Technical Report)—following the W3C process under the coordination, review, and approval of the AG WG—that describes: <ul>
					...
					<li>clarification of challenges of applying particular  WCAG 2.x success criteria could apply to non-web technologies, including closed product software,</li>

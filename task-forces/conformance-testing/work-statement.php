...
<?php include "../../_head.phi"; ?>
		<title>Accessibility Conformance Testing (ACT) Task Force Work Statement (2020)</title>
	</head>
	<body>
<?php include "../../_header.phi"; ?>
		<h1>Accessibility Conformance Testing (ACT) Task Force Work Statement (2020)</h1>
		...
		<section id="facilitation">
			...
			<ul>
				...
				<li><strong>Staff Contact: </strong><a href="https://www.w3.org/People/shadi/">Shadi Abou-Zahra</a></li>
			</ul>
		</section>

				...
				<nav class="nav standalone-resource-pager" aria-label="{$documentset.name}">
					<ul>
						...
						<xsl:if test="$meta/self::guideline or $meta/self::understanding">
							<li><xsl:call-template name="nav-level1-prev"/></li>
							<li><xsl:call-template name="nav-level1-next"/></li>
						</xsl:if>
						<xsl:if test="$meta/self::success-criterion">
							<li><xsl:call-template name="nav-level1-cur"/></li>
							<li><xsl:call-template name="nav-level2-prev"/></li>
							<li><xsl:call-template name="nav-level2-next"/></li>
						</xsl:if>
								<!--
							<li>
								<xsl:choose>
